    ...
    <tr>
        ...
        <td>
            @if($order->payment_status === 'paid')
                <button type="button" class="btn btn-sm btn-success order-payment-btn" data-id="{{ $order->id }}" data-status="unpaid" style="width: 100px;">
                    <i class="bi bi-check-circle-fill"></i> Paid
                </button>
            @else
                <button type="button" class="btn btn-sm btn-danger order-payment-btn" data-id="{{ $order->id }}" data-status="paid" style="width: 100px;">
